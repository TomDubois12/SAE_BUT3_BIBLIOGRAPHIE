...
def readGraph_and_write(fileGraph, outputFile):
    ...
    #Write the html of the graph generated by pyvis in the div with the class "TargetDiv in the file renderer/graphe.html"
...
if __name__ == "__main__":
    ...
    try:
        ...
        if(len(sys.argv) > 2 and len(sys.argv[1]) > 0):
            ...
            readGraph_and_write(pyvis_path + "/bin/nx.html", renderer_path + "/graphe.html")
